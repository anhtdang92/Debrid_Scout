...
def about():
    ...
    try:
        ...
        logger.info("Successfully retrieved Real-Debrid account information for About page.")
    except RealDebridError as e:
        logger.error("Failed to retrieve Real-Debrid account information for About page", exc_info=True)
